/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 73a34568cb5921112e0467026532f938)
// Runtime types generated with workerd@1.20260710.1 2026-07-12 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	DEV_PROXY_PUBLIC: string;
	API: Fetcher /* plyrs-api-preview */ | Fetcher /* plyrs-api */;
}
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		ASSETS: Fetcher;
		DEV_PROXY_PUBLIC: string;
		API: Fetcher /* plyrs-api-preview */;
	}
	interface ProductionEnv {
		ASSETS: Fetcher;
		DEV_PROXY_PUBLIC: string;
		API: Fetcher /* plyrs-api */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEV_PROXY_PUBLIC">> {}
}
